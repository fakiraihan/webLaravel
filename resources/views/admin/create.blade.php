...
@section('title', 'Create Article - Blog Admin')
...
<div class="px-40 flex flex-1 justify-center py-5">
  <div class="layout-content-container flex flex-col max-w-[960px] flex-1">
    <div class="flex flex-wrap justify-between gap-3 p-4">
      <p class="text-white tracking-light text-[32px] font-bold leading-tight min-w-72">Create New Article</p>
    </div>
    ...
    <form method="POST" action="{{ route('admin.store') }}" class="p-4">
      @csrf
      ...
      <div class="flex gap-4">
        ...
        >
          <span class="truncate">Create Article</span>
        </button>
        <a href="{{ route('admin.index') }}" class="flex min-w-[84px] max-w-[480px] cursor-pointer items-center justify-center overflow-hidden rounded-full h-10 px-4 bg-[#2d372a] text-white text-sm font-bold leading-normal tracking-[0.015em]">
